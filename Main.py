...
def create_tables():
    ...
    c1 = conection.cursor()
    # Tabla Pedido
    c1.execute('''CREATE TABLE pedido (id_pedido INT PRIMARY KEY NOT NULL,
                                        fecha_pedido TEXT NOT NULL,
                                        nombrecliente_pedido TEXT NOT NULL)''')
    # Tabla Tamaño
    c1.execute('''CREATE TABLE tamano (id_tamano INT PRIMARY KEY NOT NULL,
                                        nombre_tamano TEXT NOT NULL,
                                        costo_tamano REAL NOT NULL)''')
    # Tabla Ingrediente
    c1.execute('''CREATE TABLE ingrediente (id_ingrediente INT PRIMARY KEY NOT NULL,
    ...
    c1.execute('''CREATE TABLE pizza_ingrediente (fk_pizza INT NOT NULL,
